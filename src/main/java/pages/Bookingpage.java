...
public class Bookingpage extends ProjectSpecificationMethod {
	...
	public Bookingpage Checkin() {
		...
		{
			System.out.println("Checkin Feild Available In Booking Page");
		} 
		else
		{
			System.out.println("Checkin Feild Not Available In Booking Page");
		}
	...
	public Bookingpage Flightstatus() {
		...
		{
			System.out.println("Flight Status Feild Available In Booking Page");
		} 
		else 
		{
			System.out.println("Flight Status Feild Not Available In Booking Page");
		}
		return this;
	}
	...
	public Bookingpage ManageBooking() {
		...
		{
			System.out.println("Manage Booking Feild Available In Booking Page");
		} 
		else 
		{
			System.out.println("Manage Booking Feild Not Available In Booking Page");
		}

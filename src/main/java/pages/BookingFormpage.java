...
public class BookingFormpage extends ProjectSpecificationMethod {
	...
	public BookingFormpage firstname() {
		...
		findElement("Xpath", "//input[@data-testid='first-inputbox-contact-details']").sendKeys("Dharaneeshkumar");
		return this;
	}
	...
	public BookingFormpage lastname() {
		...
		findElement("Xpath", "//input[@data-testid='last-inputbox-contact-details']").sendKeys("Dhamotharan");
		return this;
	}
	...
	public BookingFormpage contact_Number() {
		...
		findElement("Xpath", "//input[@data-testid='contact-number-input-box']").sendKeys("9489131119");
		return this;
	...
	public BookingFormpage email_Id() {
		...
		findElement("Xpath", "//input[@data-testid='emailAddress-inputbox-contact-details']").sendKeys("sddharaneeshkumar@gmail.com");
		return this;
	}

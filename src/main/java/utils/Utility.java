...
public class Utility {
	...
	public String[][] excelRead() throws IOException {
		...
		XSSFWorkbook book = new XSSFWorkbook("D:\\dharaneesh\\FINAL YEAR PROJECT\\guvi\\New folder (2)\\SpiceJet (1)\\SpiceJet\\Testdata\\" + excelfile + ".xlsx");
	...
	public String getScreenshot(String screenshotname) throws IOException {
		...
		String path = "D:\\dharaneesh\\FINAL YEAR PROJECT\\guvi\\New folder (2)\\SpiceJet (1)\\SpiceJet\\Screenshots\\" + screenshotname + ".png";
